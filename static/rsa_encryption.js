...
const generateRSAKeyPair = async () => {
    const keyPair = await window.crypto.subtle.generateKey(encryptAlgorithm, true, ["encrypt", "decrypt"]);
    const keyPairPem = {
        publicKey: '',
        privateKey: '',
    };
...
const encryptRsa = async (fileArrayBuffer, pemString) => {
...
const decryptRsa = async (fileArrayBuffer, pemString) => {
    const keyArrayBuffer = convertPemToBinary(pemString);
...
const encryptStringRsa = async (str, pemString) => {
...
const decryptStringRsa = async (str, pemString) => {
